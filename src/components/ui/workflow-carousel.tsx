...
export function WorkflowCarousel({ steps }: WorkflowCarouselProps) {
  ...
  return (
    <>
      {/* Desktop Carousel */}
      <div className="hidden md:relative md:overflow-hidden">
        ...
        <div className="relative h-[29rem]">
          <AnimatePresence initial={false} custom={direction}>
            ...
            >
              <div className="grid grid-cols-1 gap-12 items-end flex-grow " style={{ gridTemplateColumns: '30% 1fr' }}>
                <h3 className="text-5xl font-headline uppercase">{currentStep.title}</h3>
        ...
        {steps.map((step, index) => (
          <div key={step.id} className="flex flex-col space-y-4">
            <div className="flex items-center w-full">
              ...
              <span className="mx-4 font-bold text-lg border border-gray-400 px-3 py-1">{index + 1}</span>
              <Separator className="flex-grow" />
            </div>
            ...
            <div className="text-center px-2">
              <h3 className="text-3xl font-headline uppercase mb-2">{step.title}</h3>
