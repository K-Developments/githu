...
import { Home, User, Package, Map, Inbox, Mail, HelpCircle, ImageIcon, Briefcase } from "lucide-react";
                ...
                <SidebarContent>
                    <SidebarMenu>
                        <SidebarMenuItem>
                         ...
                         <SidebarMenuItem>
                            <Link href="/admin/services" passHref legacyBehavior>
                                <SidebarMenuButton asChild isActive={pathname === '/admin/services'} tooltip="Services Page">
                                    <a>
                                        <Briefcase />
                        ...
                        <SidebarMenuItem>
                            <Link href="/admin/gallery" passHref legacyBehavior>
                                <SidebarMenuButton asChild isActive={pathname === '/admin/gallery'} tooltip="Gallery Page">
                                    <a>
                                        <ImageIcon />
                        ...
                        <SidebarMenuItem>
                            <Link href="/admin/contact" passHref legacyBehavior>
                                <SidebarMenuButton asChild isActive={pathname === '/admin/contact'} tooltip="Contact Page">
                                    <a>
                                        <Mail />
                         ...
                         <SidebarMenuItem>
                            <Link href="/admin/faq" passHref legacyBehavior>
                                <SidebarMenuButton asChild isActive={pathname === '/admin/faq'} tooltip="FAQ Page">
                                    <a>
                                        <HelpCircle />
                                        <span>FAQ Page</span>
                                    </a>
